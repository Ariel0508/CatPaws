<template>
    ...
    text-center vh-100 w-100">
      <div class="row">
        <form class="form-signin bg-vanilla shadow p-5 rounded w-100" @submit.prevent="login">
          ...
          <button class="w-100 btn btn-lg btn-brown mt-4" type="submit">登入</button>
